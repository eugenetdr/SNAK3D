...
module mojo_top_0 (
  ...
  always @* begin
    ...
    M_control_game_button[0+1-:2] = game_button[0+1-:2];
    M_game_game_state = M_control_game_state;
    ...
    time_display[0+13-:14] = M_timerseg_q[0+13-:14];
    score_display[0+13-:14] = M_scoreseg_q[0+13-:14];
  end
endmodule
